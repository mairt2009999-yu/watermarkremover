...
/**
 * Get dynamic external routes that can be configured via environment variables
 */
export const getDynamicRoutes = () => {
  const externalLinks = {
    roadmap: process.env.NEXT_PUBLIC_ROADMAP_URL || Routes.Roadmap,
    documentation: process.env.NEXT_PUBLIC_DOCS_URL || Routes.Docs,
    support: process.env.NEXT_PUBLIC_SUPPORT_URL || Routes.Contact,
  };
