...
export type FeatureType = 'watermark_removal' | 'batch_process' | 'ai_enhancement' | 'hd_processing';
...
export function getUpgradeOptions(currentCredits: number): PlanUpgradeBenefit[] {
