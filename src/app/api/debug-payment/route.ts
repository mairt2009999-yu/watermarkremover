...
import { websiteConfig, getPriceId, getPaymentProvider } from '@/config/website';
import { getAllPricePlans, findPlanByPlanId, findPriceInPlan } from '@/lib/price-plan';
  ...
  try {
    ...
    const debugInfo = {
      environment: {
        ...
        NEXT_PUBLIC_CREEM_PRICE_PRO_MONTHLY: process.env.NEXT_PUBLIC_CREEM_PRICE_PRO_MONTHLY,
        NEXT_PUBLIC_CREEM_PRICE_PRO_YEARLY: process.env.NEXT_PUBLIC_CREEM_PRICE_PRO_YEARLY,
        NEXT_PUBLIC_CREEM_PRICE_LIFETIME: process.env.NEXT_PUBLIC_CREEM_PRICE_LIFETIME,
